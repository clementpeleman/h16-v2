...
function AppHeader() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="z-10 max-w-screen-2xl xl:max-w-screen-2xl block sm:flex  sm:items-center py-6">
        ...
        >
          <div className="block text-left text-lg text-primary-dark dark:text-ternary-light hover:text-secondary-dark dark:hover:text-secondary-light  sm:mx-4 mb-2 sm:py-2 my-8">
          ...
          <div className="border-t-2 pt-3 sm:pt-0 sm:border-t-0 border-primary-light dark:border-secondary-dark">
            <button
              ...
              className="font-general-medium sm:hidden block text-left text-md border-2 border-primary text-primary hover:bg-primary hover:text-white shadow-sm rounded-sm px-4 py-2 mt-2 duration-300 w-34"
        ...
        <div className="hidden sm:flex justify-between items-center flex-col md:flex-row ml-auto">
